...
public class ActivityNowPlaying2 extends ActivityMaster implements MediaController.MediaPlayerControl,AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
    ...
    private void newPlaylist() {
        ...
        final EditText input = new EditText(ActivityNowPlaying2.this);

        // Labels
        String dialogTitle  = ActivityNowPlaying2.this.getString(R.string.menu_now_playing_dialog_create_playlist_title);
        String dialogText   = ActivityNowPlaying2.this.getString(R.string.menu_now_playing_dialog_create_playlist_subtitle);
        String buttonOK     = ActivityNowPlaying2.this.getString(R.string.menu_now_playing_dialog_create_playlist_button_ok);
        String buttonCancel = ActivityNowPlaying2.this.getString(R.string.menu_now_playing_dialog_create_playlist_button_cancel);

        // Creating the dialog box that asks the user,
        // with the question and options.
        new AlertDialog.Builder(ActivityNowPlaying2.this)
                ...
                .setPositiveButton(buttonOK, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        kMP.songs.newPlaylist(ActivityNowPlaying2.this, "external", playlistName, kMP.nowPlayingList);

                        String createPlaylistText = ActivityNowPlaying2.this.getString(R.string.menu_now_playing_dialog_create_playlist_success, playlistName);

                        // Congratulating the user with the
                        // new Playlist name
                        Toast.makeText(ActivityNowPlaying2.this,
                                createPlaylistText,
...
public void refreshActionBarSubtitle() {
    ...
    private void setMusicController() {
        musicController = new MusicController(ActivityNowPlaying2.this);
